...
| `+department-get` | Get department info by department ID |
| `+department-children` | List child departments under a department |
| `+department-users-list` | List direct users in a department |
