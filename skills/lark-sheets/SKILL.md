...
| `+read-rich` | Read rich-text cell values with the V3 Sheets API |
| `+write-rich` | Write rich-text cell values with the V3 Sheets API |
| `+merge` | Merge cells in a sheet range |
| `+style` | Apply cell styles to a sheet range |
| `+add-cols` | Add columns to a sheet |
